...
# Fix dependency to systemd-udevd in tpm2-tss
# https://github.com/dracutdevs/dracut/pull/1526
Patch4: 0001-fix-tpm2-tss-typo-in-depends.patch
...
%changelog
* Sat Sep 25 2021 Evan Anderson <evan@eaanderson.com> - 055-4
- Backport: fix(tpm2-tss): typo in depends()
